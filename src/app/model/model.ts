...
import { VisualizerType } from '../type/visualizerType';
...
export abstract class Model {
  ...
  async adjustRegions(numRegions: number): Promise<void> {
    if (this.country.locations.length < numRegions) {
      this.appendRegions(numRegions - this.country.locations.length);
    }
    if (this.country.locations.length > numRegions) {
